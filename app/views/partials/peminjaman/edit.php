                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-tgl_pengembalian" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['tgl_pengembalian']; ?>" type="datetime" name="tgl_pengembalian" placeholder="Enter Tgl Pengembalian" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-nama_peminjam"  value="<?php  echo $data['nama_peminjam']; ?>" type="text" placeholder="Enter Nama Peminjam"  required="" name="nama_peminjam"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
