...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Tambah Dokumen Baru</h4>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-judul_buku"  value="<?php  echo $this->set_field_value('judul_buku',""); ?>" type="text" placeholder="Enter Judul"  required="" name="judul_buku"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-pengarang"  value="<?php  echo $this->set_field_value('pengarang',""); ?>" type="text" placeholder="Enter Pembuat Dokumen"  required="" name="pengarang"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
