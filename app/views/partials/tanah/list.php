...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Tanah</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="td-sno">#</th>
                                                <th  class="td-nama_lokasi"> Nama Lokasi</th>
                                                <th  class="td-kode_lokasi"> Kode Lokasi</th>
                                                <th  class="td-luas_tanah"> Luas Tanah</th>
                                                <th  class="td-tahun_pengadaan"> Tahun Pengadaan</th>
                                                <th  class="td-letak_alamat"> Letak Alamat</th>
