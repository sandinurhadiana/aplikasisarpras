		...
		<table class="table table-sm">
			<tr>
				...
				<th align="left" valign="middle">
					...
					<small class="sub-title">Institut Agama Islam Tasikmalaya</small>
				</th>
				<th align="right" valign="middle">
					<div class="company-info">
						<div>Phone: <span class="sub-title">(0265) 331501</span></div>
						<div>Email: <span class="sub-title">iaitasik@iaitasik.ac.id</span></div>
						<div>Web: <span class="sub-title">www.iaitasik.ac.id</span></div>
					</div>
		...
		<table class="table table-sm">
			<tr>
				...
				<td align="left" valign="middle">
					Alamat: Jl. Noenoeng Tisnasaputra No.16, Kahuripan, Kec. Tawang, Kab. Tasikmalaya, Jawa Barat 46115.
				</td>
