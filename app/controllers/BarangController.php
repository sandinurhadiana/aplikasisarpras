...
class BarangController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				barang.Harga_total LIKE ? OR 
				barang.Sumber LIKE ? OR 
				barang.Ruang LIKE ? OR 
				barang.foto LIKE ? OR 
				barang.Kondisi LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("kode_barang","nama_barang","merk","spesifikasi","Jumlah_barang","Harga_total","Sumber","Ruang","foto","Kondisi");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","kode_barang","nama_barang","merk","spesifikasi","Jumlah_barang","Harga_total","Sumber","Ruang","foto","Kondisi");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'kode_barang' => 'required',
